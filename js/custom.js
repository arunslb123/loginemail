               ...
               // var jsondata = $.parseJSON(data);
                ...
                for(var i=0;i<data.songjson.length;i++){
                   ...
                   if(data.songjson[i].time<=5){
                                  ...
                                  $("#displayvideo").append(
                        '<div class="col-md-6 col-lg-4 movie-tile text-center col-centered bgvideo first embed-responsive-item" data-trailer-youtube-id="' + data.songjson[i].url + '" data-toggle="modal" data-target="#trailer">' + 
                   ...
                   if(data.songjson[i].time>5 && data.songjson[i].time<=10){
                                      ...
                                      $("#displayvideo").append(
                        '<div class="col-md-6 col-lg-4 movie-tile text-center col-centered bgvideo second embed-responsive-item" data-trailer-youtube-id="' + data.songjson[i].url + '" data-toggle="modal" data-target="#trailer">' + 
                            '<img src="http://img.youtube.com/vi/' + data.songjson[i].url + '/0.jpg" width="100" height="100">' +
                            '<h4>' + data.songjson[i].title + '</h4>' + 
                        '</div>'
                    );
                    ...
                    if(data.songjson[i].time>10 && data.songjson[i].time<=20){
                                      ...
                                      $("#displayvideo").append(
                        '<div class="col-md-6 col-lg-4 movie-tile text-center bgvideo col-centered third embed-responsive-item" data-trailer-youtube-id="' + data.songjson[i].url + '" data-toggle="modal" data-target="#trailer">' + 
                            '<img src="http://img.youtube.com/vi/' + data.songjson[i].url + '/0.jpg" width="100" height="100">' +
                            '<h4>' + data.songjson[i].title + '</h4>' + 
                        '</div>'
                    );
                    ...
                    if(data.songjson[i].time>20){
                                      ...
                                      $("#displayvideo").append(
                        '<div class="col-md-6 col-lg-4 movie-tile text-center col-centered bgvideo fourth embed-responsive-item" data-trailer-youtube-id="' + data.songjson[i].url + '" data-toggle="modal" data-target="#trailer">' + 
                            '<img src="http://img.youtube.com/vi/' + data.songjson[i].url + '/0.jpg" width="100" height="100">' +
                            '<h4>' + data.songjson[i].title + '</h4>' + 
                        '</div>'
                    );
